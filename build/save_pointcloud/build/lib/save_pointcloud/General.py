...
class FrameListener(Node):
    ...
    def scan_callback(self, scan):
        ...
        # point_cloud_data.extend(points_transformed.tolist())
        	table_scan = table_scan.append({
    'timestamp': scan.header.stamp.sec + scan.header.stamp.nanosec * 1e-9,
    'x': 0,
    'y': 0,
    'z': 0
}, ignore_index=True)
        	table_tf = table_tf.append({'timestamp': transform_stamped.header.stamp.sec + transform_stamped.header.stamp.nanosec * 1e-9,
                                        ...
                                        'qw': transform_stamped.transform.rotation.w}, ignore_index=True)
        with open ('/home/laura/ros2_ws/src/save_pointcloud/save_pointcloud/pcd_files/NDT.pcd','wb') as f:
